...
v = 0; % begin speed
a165 = 1.217; % acceleration with motor at full power
a135 = -6.57; % acceleration with motor full power backwards while moving forwards
...
%%% distance
tmp = linspace(0.23,0.23,40); % add 0.05 for short begin dist and substr 0.05 for long begin dist
